CREATE OR REPLACE VIEW "ca"."wwtp_resource" AS (
...
COMMENT ON VIEW "ca"."wwtp_resource" IS
'Collects resource data for CA WWTPs by WWTPSize (WWTP0to1, WWTP1to10, WWTP10to100, WWTP100Up).

Corresponds to data for the following Stella variables
    WWTP.Initial_WTE_Distribution (number facilities)
    WWTP.per_facility_CH4_collection (avg_methane_m3_per_facility_yr)
    WWTP.daily_facility_influx (avg_flow_mgd_avg)
