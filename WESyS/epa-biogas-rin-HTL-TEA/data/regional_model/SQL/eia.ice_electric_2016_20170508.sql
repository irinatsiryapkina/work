...
GRANT SELECT ON "dhetting"."ice_electric-2016" TO "wte-admin";

SET ROLE "wte-admin";

-- raw copy
DROP   TABLE IF EXISTS "eia"."_ice_electric_2016_20170508";
CREATE TABLE           "eia"."_ice_electric_2016_20170508" (
       "Price hub"                TEXT
     , "Trade date"               TEXT
...
COMMENT ON TABLE "eia"."_ice_electric_2016_20170508" IS 'EIA wholesale electricity price. May 8, 2017. https://www.eia.gov/electricity/wholesale/#history.';

INSERT INTO "eia"."_ice_electric_2016_20170508" SELECT * FROM "dhetting"."ice_electric-2016";


-- clean copy
DROP   TABLE IF EXISTS "eia"."ice_electric_2016_20170508";
CREATE TABLE           "eia"."ice_electric_2016_20170508" (
     ...
     , CONSTRAINT "unq_ice_electric_2016_20170508" UNIQUE ("price_hub", "trade_date", "delivery_start_date", "delivery_end_date", "high_price_dol_mwh", "low_price_dol_mwh", "wtd_avg_price_dol_mwh", "change", "daily_volume_mwh", "number_of_trades", "number_of_counterparties")
);
COMMENT ON TABLE "eia"."ice_electric_2016_20170508" IS 'EIA wholesale electricity price. May 8, 2017. https://www.eia.gov/electricity/wholesale/#history.';

INSERT INTO "eia"."ice_electric_2016_20170508" ("price_hub", "trade_date", "delivery_start_date", "delivery_end_date", "high_price_dol_mwh", "low_price_dol_mwh", "wtd_avg_price_dol_mwh", "change", "daily_volume_mwh", "number_of_trades", "number_of_counterparties")
WITH "raw" AS (SELECT DISTINCT
                ...
                FROM "eia"."_ice_electric_2016_20170508"
)
SELECT "Price hub"
...
--SELECT * FROM "eia"."ice_electric_2016_20170508";
