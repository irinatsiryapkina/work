CREATE OR REPLACE VIEW "rotus"."landfill_distribution" AS (
...
COMMENT ON VIEW "rotus"."landfill_distribution" IS
'Computes number of landfills for ROTUS from LMOP data
