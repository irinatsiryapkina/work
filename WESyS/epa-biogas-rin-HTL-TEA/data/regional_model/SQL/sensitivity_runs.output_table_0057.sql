-- create table
DROP   TABLE IF EXISTS "sensitivity_runs"."output_table_0057" CASCADE;
CREATE TABLE           "sensitivity_runs"."output_table_0057" (CONSTRAINT "output_table_0057_run_config_check" CHECK ("run_config" = 57)) INHERITS ("sensitivity_runs"."output_table");

-- add primary key constraints
ALTER  TABLE "sensitivity_runs"."output_table_0057" ADD CONSTRAINT "pkey_output_table_0057" PRIMARY KEY ("gid");

-- add indices
CREATE INDEX "idx_output_table_0057_factor_btree" ON "sensitivity_runs"."output_table_0057" USING BTREE ("factor");
CREATE INDEX "idx_output_table_0057_run_id_btree" ON "sensitivity_runs"."output_table_0057" USING BTREE ("run_id");
CREATE INDEX "idx_output_table_0057_brin_time"    ON "sensitivity_runs"."output_table_0057" USING BRIN  ("time");


-- check for records where run_id != factor 'run_id'
DROP   MATERIALIZED VIEW IF EXISTS "sensitivity_runs"."output_table_0057_invalid_run_id" CASCADE;
CREATE MATERIALIZED VIEW           "sensitivity_runs"."output_table_0057_invalid_run_id" AS (
	SELECT DISTINCT "run_id"
	FROM "sensitivity_runs"."output_table_0057"
...
DROP   MATERIALIZED VIEW IF EXISTS "sensitivity_runs"."output_table_0057_run_id" CASCADE;
CREATE MATERIALIZED VIEW           "sensitivity_runs"."output_table_0057_run_id" AS (
	SELECT "run_id"
...
DROP   MATERIALIZED VIEW IF EXISTS "sensitivity_runs"."run_config_0057_progress" CASCADE;
CREATE MATERIALIZED VIEW           "sensitivity_runs"."run_config_0057_progress" AS (
	WITH x AS (
...
DROP   MATERIALIZED VIEW IF EXISTS "sensitivity_runs"."run_config_0057_missing_run_ids" CASCADE;
CREATE MATERIALIZED VIEW           "sensitivity_runs"."run_config_0057_missing_run_ids" AS (
	WITH "expected" AS (SELECT GENERATE_SERIES(1, (SELECT MAX("end_index") FROM "sensitivity_runs"."run_config_0057_progress")) AS "run_id")
	SELECT a."run_id"
	FROM "expected" a
	FULL JOIN "sensitivity_runs"."output_table_0057_run_id" b ON a."run_id" = b."run_id"
...
-- polish table
--VACUUM FULL ANALYZE "sensitivity_runs"."output_table_0057";

--REFRESH MATERIALIZED VIEW "sensitivity_runs"."output_table_0057_run_id";
--REFRESH MATERIALIZED VIEW "sensitivity_runs"."output_table_0057_invalid_run_id";
--REFRESH MATERIALIZED VIEW "sensitivity_runs"."run_config_0057_progress";
--REFRESH MATERIALIZED VIEW "sensitivity_runs"."run_config_0057_missing_run_ids";

-- 1-pct table
CREATE VIEW "sensitivity_runs"."output_table_0057_1pct" AS SELECT a.* FROM "sensitivity_runs"."output_table_0057" a RIGHT JOIN (SELECT GENERATE_SERIES(0, (SELECT MAX("end_index") FROM "sensitivity_runs"."run_config_0057_progress")) AS "run_id" ORDER BY RANDOM() LIMIT (SELECT MAX("end_index") FROM "sensitivity_runs"."run_config_0057_progress") / 100.0) b ON a."run_id" = b."run_id";
--\COPY (SELECT * FROM "sensitivity_runs"."output_table_0057_1pct") TO 'sensitivity_runs.output_table_0057_1pct.csv' WITH CSV HEADER DELIMITER ','
--zip -m sensitivity_runs.output_table_0057_1pct.zip sensitivity_runs.output_table_0057_1pct.csv
--scp dhetting@walter.nrel.gov:/srv/data/wte/sensitivity_runs.output_table_0057_1pct.csv.zip ~/Box\ Sync/WESyS_Project/data_wte/sensitivity_runs.output_table_0057_1pct.csv.zip
