CREATE OR REPLACE VIEW "national"."wwtp_resource" AS (
...
COMMENT ON VIEW "national"."wwtp_resource" IS
'Collects resource data for national WWTPs by WWTPSize (WWTP0to1, WWTP1to10, WWTP10to100, WWTP100Up).
