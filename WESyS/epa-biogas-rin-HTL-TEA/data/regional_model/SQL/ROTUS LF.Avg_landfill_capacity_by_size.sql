CREATE OR REPLACE VIEW "ROTUS LF"."Avg_landfill_capacity_by_size" AS (
...
SELECT 'ROTUS LF.Avg_landfill_capacity_by_size[LFLarge]' AS "variable", COALESCE((SELECT "avg_waste_in_place_tons" FROM "avg_size" WHERE "LFSize" = 'LFLarge'), 0.0) AS "val_2015"
...
UNION ALL
SELECT 'ROTUS LF.Avg_landfill_capacity_by_size[LFSmall]' AS "variable", COALESCE((SELECT "avg_waste_in_place_tons" FROM "avg_size" WHERE "LFSize" = 'LFSmall'), 0.0) AS "val_2015"
                                                                      , 0.0::NUMERIC                                                                                 AS "val_2016"
                                                                      , 0.0::NUMERIC                                                                                 AS "val_2017"
                                                                      , 0.0::NUMERIC                                                                                 AS "val_2018"
                                                                      , 0.0::NUMERIC                                                                                 AS "val_2019"
