...
GRANT SELECT ON "dhetting"."ice_natgas-2016final" TO "wte-admin";

SET ROLE "wte-admin";

-- raw copy
DROP   TABLE IF EXISTS "eia"."_ice_natgas_2016final_20170510";
CREATE TABLE           "eia"."_ice_natgas_2016final_20170510" (
       "Price hub"                TEXT
     , "Trade date"               TEXT
...
COMMENT ON TABLE "eia"."_ice_natgas_2016final_20170510" IS 'EIA wholesale electricity price. May 10, 2017. https://www.eia.gov/electricity/wholesale/#history.';

INSERT INTO "eia"."_ice_natgas_2016final_20170510" SELECT * FROM "dhetting"."ice_natgas-2016final";


-- clean copy
DROP   TABLE IF EXISTS "eia"."ice_natgas_2016final_20170510";
CREATE TABLE           "eia"."ice_natgas_2016final_20170510" (
     ...
     , CONSTRAINT "unq_ice_natgas_2016final_20170510" UNIQUE ("price_hub", "trade_date", "delivery_start_date", "delivery_end_date", "high_price_dol_mmbtu", "low_price_dol_mmbtu", "wtd_avg_price_dol_mmbtu", "change", "daily_volume_mmbtu", "number_of_trades", "number_of_counterparties")
);
COMMENT ON TABLE "eia"."ice_natgas_2016final_20170510" IS 'EIA wholesale electricity price. May 10, 2017. https://www.eia.gov/electricity/wholesale/#history.';

INSERT INTO "eia"."ice_natgas_2016final_20170510" ("price_hub", "trade_date", "delivery_start_date", "delivery_end_date", "high_price_dol_mmbtu", "low_price_dol_mmbtu", "wtd_avg_price_dol_mmbtu", "change", "daily_volume_mmbtu", "number_of_trades", "number_of_counterparties")
WITH "raw" AS (SELECT DISTINCT
                ...
                FROM "eia"."_ice_natgas_2016final_20170510"
)
SELECT "Price hub"
...
--SELECT * FROM "eia"."ice_natgas_2016final_20170510";
